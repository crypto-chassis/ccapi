...
TEST(HmacTest, hmac256ReturnHex) {
  auto result = Hmac::hmac(
      Hmac::ShaVersion::SHA256, "NhqPtmdSJYdKjVHjA7PZj4Mge3R5YNiP1e3UZjInClVN65XAbvqqM6A7H5fATj0j",
...
TEST(HmacTest, hmac256) {
  auto result = UtilAlgorithm::base64Encode(Hmac::hmac(
      Hmac::ShaVersion::SHA256,
      UtilAlgorithm::base64Decode(
