...
* For paper trading, please see see section "only applicable to paper trade" in the [parameter configuration file `app/src/spot_market_making/config.env.example`](app/src/spot_market_making/config.env.example) to set additional parameters.
