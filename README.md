...
**NEW**: Version 2.2.x released execution management for coinbase, gemini, and the binance family (binance, binance-futures, and binance-us).
...
* Supported exchanges:
  ...
  * Execution Management: coinbase, gemini, binance-us, binance, binance-futures.
