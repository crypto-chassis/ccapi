...
* For paper trading and backtesting, please see section "only applicable to paper trade and backtest" in the [parameter configuration file `app/src/spot_market_making/config.env.example`](app/src/spot_market_making/config.env.example) to set additional parameters.
