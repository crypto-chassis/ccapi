...
#include "ccapi_cpp/service/ccapi_market_data_service_binance_derivaties_base.h"
namespace ccapi {
class MarketDataServiceBinanceUsdsFutures : public MarketDataServiceBinanceDerivatiesBase {
 public:
  MarketDataServiceBinanceUsdsFutures(std::function<void(Event& event)> wsEventHandler, SessionOptions sessionOptions, SessionConfigs sessionConfigs,
      ...
      : MarketDataServiceBinanceDerivatiesBase(wsEventHandler, sessionOptions, sessionConfigs, serviceContextPtr) {
