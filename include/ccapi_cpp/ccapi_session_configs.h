...
namespace ccapi {
    ...
    public:
        ...
        explicit SessionConfigs(std::map<std::string, std::map<std::string, std::string> > exchangeInstrumentSymbolMap,
                ...
                : exchangeInstrumentSymbolMap(exchangeInstrumentSymbolMap),
                  exchangeInstrumentSymbolMapRest(exchangeInstrumentSymbolMapRest), credential(credential) {
    ...
    private:
        void updateExchangeInstrumentMap() {
            ...
            std::map<std::string, std::string> fieldWebsocketChannelMapHuobiUsdtPerpetual = {{
                                                                                                     CCAPI_TRADE,
                                                                                                     CCAPI_WEBSOCKET_HUOBI_USDT_PERPETUAL_CHANNEL_TRADE_DETAIL},
                                                                                             {
                                                                                                     CCAPI_MARKET_DEPTH,
                                                                                                     CCAPI_WEBSOCKET_HUOBI_USDT_PERPETUAL_CHANNEL_MARKET_DEPTH},};
            ...
            std::map<std::string, std::string> fieldWebsocketChannelMapOkexPerpetual = {{
                                                                                                CCAPI_TRADE,
                                                                                                CCAPI_WEBSOCKET_OKEX_PERPETUAL_CHANNEL_TRADE},
                                                                                        {
                                                                                                CCAPI_MARKET_DEPTH,
                                                                                                CCAPI_WEBSOCKET_OKEX_PERPETUAL_CHANNEL_PUBLIC_DEPTH400},};
            ...
            for (auto const &fieldWebsocketChannel : fieldWebsocketChannelMapHuobiUsdtPerpetual) {
                this->exchangeFieldMap[CCAPI_EXCHANGE_NAME_HUOBI_USDT_PERPETUAL].push_back(fieldWebsocketChannel.first);
            }
            ...
            for (auto const &fieldWebsocketChannel : fieldWebsocketChannelMapOkexPerpetual) {
                this->exchangeFieldMap[CCAPI_EXCHANGE_NAME_OKEX_PERPETUAL].push_back(fieldWebsocketChannel.first);
            }
            ...
            this->exchangeFieldWebsocketChannelMap = {
                    {CCAPI_EXCHANGE_NAME_HUOBI_USDT_PERPETUAL, fieldWebsocketChannelMapHuobiUsdtPerpetual},
                    {CCAPI_EXCHANGE_NAME_OKEX_PERPETUAL, fieldWebsocketChannelMapOkexPerpetual},
            ...
            this->websocketAvailableMarketDepth = {
                    {CCAPI_EXCHANGE_NAME_HUOBI_USDT_PERPETUAL, std::vector<int>({150})},
                    {CCAPI_EXCHANGE_NAME_OKEX_PERPETUAL, std::vector<int>({400})},
            ...
            this->urlWebsocketBase = {
                    {CCAPI_EXCHANGE_NAME_HUOBI_USDT_PERPETUAL, "wss://api.hbdm.com/linear-swap-ws"},
                    {CCAPI_EXCHANGE_NAME_OKEX_PERPETUAL,       "wss://real.okex.com:8443/ws/v3"},
        ...
        void updateExchangeInstrumentMapRest() {
            ...
            this->urlRestBase = {
                    {CCAPI_EXCHANGE_NAME_HUOBI_USDT_PERPETUAL, CCAPI_HUOBI_USDT_PERPETUAL_URL_REST_BASE},
                    {CCAPI_EXCHANGE_NAME_OKEX_PERPETUAL,       CCAPI_OKEX_PERPETUAL_URL_REST_BASE},
